...
export default function Navbar() {
  ...
  return (
    <nav className="navbar absolute w-full h-[58px] left-0 top-[25px] flex flex-row justify-between items-center px-7 gap-[195px] isolate z-[100001] xl:w-full xl:left-[5%] xl:gap-[100px] lg:gap-[40px] md:flex-row md:items-center md:justify-between md:h-auto md:p-[12px_20px] md:gap-0 md:left-0 md:right-0 md:top-[16px] md:bg-transparent md:z-[80] sm:top-[-1px]">
      <Image 
